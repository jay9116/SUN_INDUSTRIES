...
public class vieworder extends HttpServlet {
	...
	protected void service(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		try
		{
			...
			int i=0;
			pr.write("<tr><th>Sr No.</th><th>Order Date</th><th>Product Name</th><th>Size</th><th>Quantity</th></tr>" );
			while (rsobj.next())
			{
				//probj.write("<br/>");
				...
				//pr.write("<td width=\"130\"><a href=\"displaybill2.jsp?pname="+pro+"&size="+size+"&quant="+quant+" \"></a>");
			//	pr.write("</td>");
