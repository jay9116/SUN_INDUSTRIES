...
<a href="contactua.jsp" style="text-decoration: none"><button type="button" class="button">Contact Us</button></a>
...
<a href="login.jsp" style="text-decoration: none"><button type="button" class="button" id="current">Login</button></a>
  ...
  <div class="a" ><br /><br/>
<br /><center><h3>Login Area</h3></center><br/><center><form method="post" action="<%=request.getContextPath()%>/login" name="login">
