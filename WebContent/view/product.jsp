...
<form method="post" action="<%=request.getContextPath() %>/" name="product">
<div style="padding-top:20px ">
<table align ="center" border="0" style="font-family: halvetica;">
<tr>
<td colspan="4" align="center" style="color:#4D1F1F; font-family:halvetica;font-size: 25px"><br/>Products</td>
</tr>
<tr><td>&nbsp;</td></tr>
<tr>
...
<option value="M/F" style="font-family: halvetica;">M/F</option>
<option value="Eicher" style="font-family: halvetica;">Eicher</option>
<option value="JCB" style="font-family: halvetica;">JCB</option>
<option value="JCB 3DX" style="font-family: halvetica;">JCB 3DX</option>
</select>
...
<tr>
<td colspan="2" align="left" style="color:#4D1F1F;font-size:18px;font-family: halvetica;"><a href="updatematerial.jsp" style="text-decoration:none;color:#4D1F1F;">Update Material</a></td>
</tr>
</table>
</div>
