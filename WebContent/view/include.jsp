...
<a href="" style="text-decoration: none"><button type="button">Home</button></a>


<a href="" style="text-decoration: none"><button type="button">Gallery</button></a>


<a href="" style="text-decoration: none"><button type="button">About Us</button></a>


<a href="" style="text-decoration: none"><button type="button">Contact Us</button></a>


<a href="login.jsp" style="text-decoration: none"><button type="button">Login</button></a>
